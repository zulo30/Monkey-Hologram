...
En este proyecto se realizo un shader que simula el efecto de un holograma como se puede ver en la imagen:

![Alt Text](/Images/monkey.gif)

se utilizo el siguiente grafo para realizar el shader:
